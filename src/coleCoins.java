public class coleCoins {

    private static long pay(int toPay) {
    ...
    public static long payCached(int toPay) {
        short[] coins = {1, 2, 5, 10, 20, 50, 100, 200};
        int[] combos = new int[toPay + 1];  // Possible numbers of combinations for each amount stored in this array
